...
-- ----------------------------
INSERT INTO "main"."t_sys_cfg" VALUES (1, 'app_name', 'loan', '小贷登记系统web框架');
-- ----------------------------
...
-- ----------------------------
INSERT INTO "main"."t_sys_notice" VALUES (1, '世界', 10, '欢迎使用小贷登记系统', '2017-01-11 08:53:20', 1);
...
-- ----------------------------
INSERT INTO "main"."t_sys_operation_log" VALUES (1, '业务日志', '清空登录日志', 1, 'LoginLogController', 'delLog', '2018-11-27 23:49:15', '成功', '主键id=null');
INSERT INTO "main"."t_sys_operation_log" VALUES (2, '业务日志', '修改管理员', 1, 'UserMgrController', 'edit', '2018-11-27 23:49:49', '成功', '账号=boss;;;');
INSERT INTO "main"."t_sys_operation_log" VALUES (3, '业务日志', '删除管理员', 1, 'UserController', 'remove', '2018-11-28 00:01:33', '成功', '账号=test4');
INSERT INTO "main"."t_sys_operation_log" VALUES (4, '业务日志', '修改管理员', 1, 'UserMgrController', 'edit', '2018-11-28 00:03:22', '成功', '账号=test2;;;');
INSERT INTO "main"."t_sys_operation_log" VALUES (5, '业务日志', '编辑管理员', 1, 'UserController', 'save', '2018-11-28 00:08:26', '成功', '名字=测试3;;;');
INSERT INTO "main"."t_sys_operation_log" VALUES (6, '业务日志', '编辑管理员', 1, 'UserController', 'save', '2018-11-28 00:10:37', '成功', '名字=测试3;;;');
