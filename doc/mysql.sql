...
-- ----------------------------
INSERT INTO `t_biz_product_info` VALUES (3, 28, '投资公司上交息001', 0.053, 0.000, 1, 0.020, 1, 1, 1, 1, 30, 1, 1, '2019-01-22 15:07:02', '2019-01-22 15:29:32');
INSERT INTO `t_biz_product_info` VALUES (25, 24, '典当行上交息002', 0.053, 0.000, 1, 0.020, 1, 1, 1, 1, 30, 1, 1, '2019-01-22 20:13:47', '2019-01-22 20:43:42');
INSERT INTO `t_biz_product_info` VALUES (26, 28, '投资公司上交息002', 0.053, 0.000, 1, 0.020, 1, 2, 1, 1, 30, 1, 1, '2019-01-22 20:44:05', '2019-01-22 20:44:05');
...
CREATE TABLE `t_sys_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 508 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_sys_operation_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 223 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_sys_operation_log
-- ----------------------------
INSERT INTO `t_sys_operation_log` VALUES (221, '业务日志', '清空业务日志', 1, 'com.zsy.loan.admin.modular.controller.system.LogController', 'delLog', '2019-01-22 20:49:50', '成功', '主键id=null');
INSERT INTO `t_sys_operation_log` VALUES (222, '业务日志', '清空登录日志', 1, 'com.zsy.loan.admin.modular.controller.system.LoginLogController', 'delLog', '2019-01-22 20:49:54', '成功', '主键id=null');
