...
public class BeanKit {
  ...
  public static void copyProperties(Object source, Object target, CopyOptions copyOptions) {
    ...
    if (copyOptions.editable != null) {
      ...
      if (!copyOptions.editable.isInstance(target)) {
        throw new IllegalArgumentException(StrKit
            .format("Target class [{}] not assignable to Editable class [{}]",
    ...
    HashSet<String> ignoreSet = copyOptions.ignoreProperties != null ? CollectionKit
        .newHashSet(copyOptions.ignoreProperties) : null;
    for (PropertyDescriptor targetPd : targetPds) {
      Method writeMethod = targetPd.getWriteMethod();
      if (writeMethod != null && (ignoreSet == null || false == ignoreSet
        ...
        if (sourcePd != null) {
          ...
          if (readMethod != null && ClassKit
            ...
            try {
              ...
              throw new ToolBoxException(ex, "Copy property [{}] to [{}] error: {}",
                  sourcePd.getName(), targetPd.getName(), ex.getMessage());
            }
          }
        }
      }
  ...
  public static class CopyOptions {
     ...
     * @return 拷贝选项
     */
    public static CopyOptions create(Class<?> editable, boolean isIgnoreNullValue,
