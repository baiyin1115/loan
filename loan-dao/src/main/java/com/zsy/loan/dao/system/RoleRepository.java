...
public interface RoleRepository extends PagingAndSortingRepository<Role, Integer>
    , JpaRepository<Role, Integer>, JpaSpecificationExecutor<Role> {

  @Query(nativeQuery = true, value = "SELECT id, pId, NAME, ( CASE WHEN (pId = 0 OR pId IS NULL) THEN 'true' ELSE 'false' END ) isopen FROM t_sys_role")
  List roleTreeList();
