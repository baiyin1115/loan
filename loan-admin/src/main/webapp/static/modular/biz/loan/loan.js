...
Loan.initColumn = function () {
  return [
    ...
    {title:'应收利息',field:'receiveBigint',align:'center',valign:'middle',sortable:true},
    ...
    {title:'应还利息',field:'schdBigint',align:'center',valign:'middle',sortable:true},
    ...
    {title:'已还利息累计',field:'totPaidBigint',align:'center',valign:'middle',sortable:true},
