...
import com.zsy.loan.service.shiro.ShiroDbRealm;
...
public class ShiroConfig {
   ...
   */
  @Bean
  @ConditionalOnProperty(prefix = "loan", name = "spring-session-open", havingValue = "true")
   ...
   */
  @Bean
  @ConditionalOnProperty(prefix = "loan", name = "spring-session-open", havingValue = "false")
  public DefaultWebSessionManager defaultWebSessionManager(CacheManager cacheShiroManager,
    ...
    sessionManager
        .setSessionValidationInterval(LoanProperties.getSessionValidationInterval() * 1000);
    sessionManager.setGlobalSessionTimeout(LoanProperties.getSessionInvalidateTime() * 1000);
