package com.zsy.loan.admin.core.mutidatasource.config;
 ...
 */
@Component
@ConfigurationProperties(prefix = "loan.muti-datasource")
public class MutiDataSourceProperties {

  private String defaultDataSourceName = "dataSourceloan";
