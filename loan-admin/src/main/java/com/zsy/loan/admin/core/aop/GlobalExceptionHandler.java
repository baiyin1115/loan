...
import com.zsy.loan.bean.exception.InvalidKaptchaException;
...
public class GlobalExceptionHandler {
  ...
  public ErrorTip credentials(UndeclaredThrowableException e) {
    ...
    log.error("权限异常!", e);
    return new ErrorTip(BizExceptionEnum.NO_PERMITION.getCode(),
  ...
  public ErrorTip notFount(RuntimeException e) {
    ...
    log.error("运行时异常:", e);
    return new ErrorTip(BizExceptionEnum.SERVER_ERROR.getCode(),
