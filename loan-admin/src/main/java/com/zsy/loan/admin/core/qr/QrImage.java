...
public class QrImage {
  ...
  public static class Builder {
    ...
    public QrImage build() {
      return new QrImage(this.qrContent, this.qrWidth, this.qrHeight, this.qrIconFilePath,
          this.qrIconWidth,
          this.topWrodHeight, this.wordSize, this.wordContent, this.fileOutputPath);
    }
  }

  public QrImage(String qrContent, int qrWidth, int qrHeight, String qrIconFilePath,
      int qrIconWidth,
